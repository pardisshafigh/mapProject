...
<body>
    <div class="main-panel">
        ...
        <div class="box">
            <a class="statusToggle" href="<?php echo BASE_URL?>" target="_blank">🏠</a>
            <a class="statusToggle all" href="<?php echo BASE_URL?>adm.php">همه</a>
        ...
        <tr>
            ...
            <td class="text-center"><?php echo Verta::instance($loc->created_at)->format('%d %B ، %Y');; ?></td>
            <td class="text-center"><?php echo $loc->lat ?></td>
            <td class="text-center"><?php echo $loc->lng ?></td>
            <td>
    ...
    $(document).ready(function() {
        $('.preview').click(function() {
            ...
            $('#mapWivdow').attr('src','<?php echo BASE_URL ?>?loc=' + $(this).attr('data-loc'));
        });
        $('.statusToggle').click(function() {
            const btn = $(this);
            $.ajax({
                url: '<?php echo BASE_URL . 'process/statusToggle.php'?>',
                method: 'POST',
